...
public class odemeekrani extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Rezervasyon Tarihiniz:");
        ...
        jLabel4.setText("Ödemeniz gereken miktar:");

        jLabel6.setText("Ödemek istediğiniz miktar:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Double miktar=Double.valueOf(jTextField1.getText());
            int id1= Integer.valueOf(JOptionPane.showInputDialog("gelen kodu giriniz:"));
            ...
            String sql = "SELECT * FROM  salon1rezervasyon WHERE id='" + id1+ "'";
            ResultSet rs = st.executeQuery(sql);
            if(rs.next()){
                double odeme=rs.getDouble("Odeme");
                String tarih=rs.getString("Tarih");
                jLabel3.setText(tarih);
                odeme-=miktar;
                jLabel5.setText(String.valueOf(odeme));
                System.out.print("kalan miktar: "+odeme);
                String sorgu="update salon1rezervasyon set Odeme='"+odeme+"' where id='" + id1+ "'";
